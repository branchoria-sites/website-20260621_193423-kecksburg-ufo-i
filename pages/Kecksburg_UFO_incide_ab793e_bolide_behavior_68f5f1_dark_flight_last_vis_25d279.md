...
show_ads: true
description: Meteorite fragments usually stop glowing before they land, so the last bright point is not the landing point.
hero_summary: Meteorite fragments usually stop glowing before they land, so the last bright point is not the landing point.
layout: default
permalink: /dark-flight/
sidebar_expanded_urls:
- /the-kecksburg-ufo-incident/
- /bolides/
nav_short_title: Dark Flight
title: Why the Glow Ends Before the Fall
title_full: Why the Glow Ends Before the Fall
display_title_short: Dark Flight
display_title: Dark Flight
heading_title: Why the Glow Ends Before the Fall
page_heading_title: Why the Glow Ends Before the Fall
source_count: 31
infographic_count: 3
planned_sections:
- What dark flight means
- Why the last visible point misleads witnesses
- How winds and momentum shift any strewn field
...
next_link:
  ...
  short_title: Delayed Boom False
header:
  og_image: /assets/images/Kecksburg_UFO_incide_ab793e_bolide_behavior_68f5f1_dark_flight_last_vis_25d279-Illustration-1-social.jpg
  preview_image: /assets/images/Kecksburg_UFO_incide_ab793e_bolide_behavior_68f5f1_dark_flight_last_vis_25d279-Illustration-1.webp
image: /assets/images/Kecksburg_UFO_incide_ab793e_bolide_behavior_68f5f1_dark_flight_last_vis_25d279-Illustration-1-social.jpg
---
...
* Witnesses describe an apparent impact just beyond a ridge, treeline, or horizon.
* Searchers investigate the visually estimated location.
* No impact site is found.
* Later analysis places any potential fall area elsewhere.
