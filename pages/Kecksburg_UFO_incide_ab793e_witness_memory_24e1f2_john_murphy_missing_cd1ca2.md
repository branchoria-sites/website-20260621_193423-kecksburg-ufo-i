...
show_ads: true
description: The John Murphy story is compelling because it promises early evidence, but missing tapes, photos and scripts keep it from settling the case.
hero_summary: The John Murphy story is compelling because it promises early evidence, but missing tapes, photos and scripts keep it from settling the case.
layout: default
permalink: /murphy-files/
sidebar_expanded_urls:
- /the-kecksburg-ufo-incident/
- /witnesses/
nav_short_title: Murphy Files
title: The Reporter Story That Still Needs Proof
title_full: The Reporter Story That Still Needs Proof
display_title_short: Murphy Files
display_title: Murphy Files
heading_title: The Reporter Story That Still Needs Proof
page_heading_title: The Reporter Story That Still Needs Proof
source_count: 14
infographic_count: 3
planned_sections:
- What later accounts claim Murphy recorded
- Why second hand testimony is hard to verify
- What authentic station records would change
...
next_link:
  ...
  heading_title: Search Memories Are Not Object Proof
header:
  og_image: /assets/images/Kecksburg_UFO_incide_ab793e_witness_memory_24e1f2_john_murphy_missing_cd1ca2-Illustration-1-social.jpg
  preview_image: /assets/images/Kecksburg_UFO_incide_ab793e_witness_memory_24e1f2_john_murphy_missing_cd1ca2-Illustration-1.webp
image: /assets/images/Kecksburg_UFO_incide_ab793e_witness_memory_24e1f2_john_murphy_missing_cd1ca2-Illustration-1-social.jpg
---
...
Murphy's case illustrates a broader challenge in evaluating historical mysteries. A claim that evidence once existed but is now missing can never be tested in the same way as a surviving document. The absence of evidence may be meaningful, but it is not automatically proof of suppression.

Three different possibilities can coexist:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* Murphy gathered significant material that was later lost through ordinary archival neglect.
* Some material was edited or withheld for reasons unrelated to any cover-up.
* Certain stories about what Murphy possessed became larger and more detailed through repeated retelling.
...
The most valuable evidence would not be another recollection about Murphy. It would be authenticated contemporaneous records.
...
* Original WHJB broadcast tapes from December 1965.
* Draft scripts showing edits before transmission.
* Station correspondence discussing censorship, legal review or outside requests.
* Murphy's original notes, interview logs or photographs.
* Archival records documenting what material was stored, discarded or transferred.
