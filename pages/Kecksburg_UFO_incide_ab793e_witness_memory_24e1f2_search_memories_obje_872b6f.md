...
show_ads: true
description: Memories of road activity, lights and searches are not the same kind of evidence as precise claims about a recovered craft.
hero_summary: Memories of road activity, lights and searches are not the same kind of evidence as precise claims about a recovered craft.
layout: default
permalink: /search-vs-object/
sidebar_expanded_urls:
- /the-kecksburg-ufo-incident/
- /witnesses/
nav_short_title: Search vs Object
title: Search Memories Are Not Object Proof
title_full: Search Memories Are Not Object Proof
display_title_short: Search vs Object
display_title: Search vs Object
heading_title: Search Memories Are Not Object Proof
page_heading_title: Search Memories Are Not Object Proof
source_count: 47
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Did Television Freeze the Acorn Shape?
header:
  og_image: /assets/images/Kecksburg_UFO_incide_ab793e_witness_memory_24e1f2_search_memories_obje_872b6f-Illustration-1-social.jpg
  preview_image: /assets/images/Kecksburg_UFO_incide_ab793e_witness_memory_24e1f2_search_memories_obje_872b6f-Illustration-1.webp
image: /assets/images/Kecksburg_UFO_incide_ab793e_witness_memory_24e1f2_search_memories_obje_872b6f-Illustration-1-social.jpg
---

## Introduction

One of the most important mistakes in discussions of [the Kecksburg UFO incident]({{ 'the-kecksburg-ufo-incident/' | relative_url }}) is treating every witness statement as if it belongs in the same category. It does not. A resident who remembers roadblocks, flashing lights, police activity, military vehicles or a search operation is describing a different kind of evidence from a witness who claims to have seen a specific object, unusual [symbols]({{ 'symbols/' | relative_url }}) or a recovered craft. The first type of testimony concerns human activity that may have occurred after the fireball. The second concerns the nature of whatever, if anything, was recovered. Those claims require different standards of proof.
...
Separating search memories from [object claims]({{ 'object-claims/' | relative_url }}) does not solve the Kecksburg mystery. It does, however, prevent a common analytical error: allowing evidence that a search occurred to become automatic proof that a specific recovered craft existed. In historical investigations, those are two separate questions, and each must stand on its own evidence.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Examines how people form beliefs and connect evidence to conclusions, relevant to witness testimony assessment.</p>
