...
show_ads: true
description: The television replica made the space acorn visible, but it also made later memory harder to separate from the original claims.
hero_summary: The television replica made the space acorn visible, but it also made later memory harder to separate from the original claims.
layout: default
permalink: /replica/
sidebar_expanded_urls:
- /the-kecksburg-ufo-incident/
- /space-acorn/
nav_short_title: Replica
title: How a TV Prop Became the Space Acorn
title_full: How a TV Prop Became the Space Acorn
display_title_short: Replica
display_title: Replica
heading_title: How a TV Prop Became the Space Acorn
page_heading_title: How a TV Prop Became the Space Acorn
source_count: 18
infographic_count: 3
planned_sections:
- Why the replica was built
- How the prop fixed the public image
- How replicas can shape memory
...
next_link:
  ...
  heading_title: How One Witness Shaped the Space Acorn
header:
  og_image: /assets/images/Kecksburg_UFO_incide_ab793e_acorn_object_335442_unsolved_mysteries_r_fa69e8-Illustration-1-social.jpg
  preview_image: /assets/images/Kecksburg_UFO_incide_ab793e_acorn_object_335442_unsolved_mysteries_r_fa69e8-Illustration-1.webp
image: /assets/images/Kecksburg_UFO_incide_ab793e_acorn_object_335442_unsolved_mysteries_r_fa69e8-Illustration-1-social.jpg
---
...
* A specific [shape]({{ 'shape/' | relative_url }}) that could be photographed and reproduced.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides local UFO history that helps place the television-driven Kecksburg image in context.</p>
        <div class="fr-book-actions">
